...
.post-article h3 {{ font-size: 1.3rem; margin: 28px 0 10px; color: var(--mid-blue); }}
.post-article h4 {{ font-size: 1.1rem; margin: 22px 0 8px; color: var(--dark-blue); font-family: Helvetica, Arial, sans-serif; font-weight: bold; letter-spacing: 0.5px; }}
...
.post-article a {{ color: var(--light-blue); }}
.post-article a:hover {{ color: var(--mid-blue); }}
...
<div style="background:var(--off-white);border-left:3px solid var(--light-blue);padding:24px;margin:28px 0;border-radius:2px;">
<p style="margin-bottom:8px;font-size:0.78rem;letter-spacing:2.5px;text-transform:uppercase;color:var(--light-blue);">Clips from the James Lakes session</p>
<p style="margin-bottom:16px;">Two short clips from the Leap Forward 2024 session that informed this piece — both struck a nerve on LinkedIn:</p>
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:18px;">
<div style="background:#fff;border:1px solid var(--border);padding:18px;border-radius:2px;">
<p style="margin-bottom:8px;font-style:italic;font-size:0.97rem;">"If you're tracking 50, 60 metrics, you can't possibly figure out what you're going to be elite at."</p>
<p style="font-size:0.82rem;color:#667;margin-bottom:10px;">19-second clip · 363 reactions</p>
<a href="https://www.linkedin.com/in/jasonrigolli/recent-activity/videos/" target="_blank" rel="noopener" style="font-size:0.88rem;">Watch on LinkedIn ↗</a>
</div>
<div style="background:#fff;border:1px solid var(--border);padding:18px;border-radius:2px;">
<p style="margin-bottom:8px;font-style:italic;font-size:0.97rem;">"People buy from people, regardless of how great the AI tools are."</p>
<p style="font-size:0.82rem;color:#667;margin-bottom:10px;">25-second clip · 401 reactions</p>
<a href="https://www.linkedin.com/in/jasonrigolli/recent-activity/videos/" target="_blank" rel="noopener" style="font-size:0.88rem;">Watch on LinkedIn ↗</a>
</div>
</div>
</div>
